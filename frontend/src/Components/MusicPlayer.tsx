...
function MusicPlayer() {
  ...
  const playPause = () => {
    setPlaying(prevState => prevState === "/images/Play.png" ? "/images/Pause.png" : "/images/Play.png");
  }
  ...
  return (
    <motion.div
      ...
      className='h-[90px] bg-black flex flex-row justify-between fixed bottom-0 left-0 right-0 gap-x-4 z-[40] min-w-[100vw] max-w-[100vw] w-[100vw]'>
