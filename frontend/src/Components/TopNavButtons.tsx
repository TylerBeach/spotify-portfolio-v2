...
function TopNavButtons({backgroundColor, projectName}: any) { 
  ...
  return (
    <div className={`fixed flex flex-row justify-between items-center top-0 top-buttons-width pl-4 h-auto py-4 pr-12 ${backgroundColor} text-white rounded-none md:rounded-md md:top-2 z-10`}>
